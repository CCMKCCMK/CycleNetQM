...
parser = argparse.ArgumentParser(description='DoubleCycleNet for Time Series Forecasting')
...
parser.add_argument('--residual_csv_path', type=str, default='trans_remain.csv', help='path to the residual CSV file')
parser.add_argument('--cycle_csv_path', type=str, default='Q.csv', help='path to the cycle CSV file')
